      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-12">
          {[
            ...
            },
            {
              ...
              desc: "Vous savez ce qui s'est passé pendant les 45 min en cabinet. Le reste — les 167 heures suivantes — c'est une zone d'ombre.",
            },
            {
              emoji: "🔁",
        ...
        <div className="rounded-3xl p-8 md:p-10 text-center border border-[#2D5016]/40" style={{background: "linear-gradient(135deg, #2D5016 0%, #1e3a0f 100%)"}}>
          ...
          <p className="text-beige-200 text-lg max-w-2xl mx-auto leading-relaxed">
            Vos patients ont un coach dans la poche. Vous avez les données sur votre tableau de bord. <strong className="text-white">La rééducation continue — même quand vous n'êtes pas là.</strong>
          </p>
        </div>
      </div>
    </section>
